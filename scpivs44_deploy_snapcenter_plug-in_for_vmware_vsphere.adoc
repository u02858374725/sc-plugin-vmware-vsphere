...
* You must have a certificate with valid Public and Private Key files. For more information, refer to articles under https://kb.netapp.com/Advice_and_Troubleshooting/Data_Protection_and_Security/SnapCenter/SnapCenter_Certificate_Resolution_Guide[Host/Client Certificate Management] section.
